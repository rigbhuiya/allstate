...
class SideBar extends Component {
    ...
    render() {
      ...
      <div class="sidenav">
        <div class="heading">
          <label class="h">Commercial Agent</label>
          <a href="#commercialagent">Commercial Agent</a>
          <label class="h">I Want To</label>
          ...
          <label class="h">Insured Information</label>
